...
const Timer = () => {
  ...
  return (
    <div className="app">
      ...
      {tipo === 'Cuenta Regresiva' && <input min='0' type="number" ref={myRef} onChange={agregaSegundos} placeholder="Ingresa Segundos" autoComplete="off"/>}    </div>
  );
};
